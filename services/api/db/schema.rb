...
ActiveRecord::Schema[7.1].define(version: 23) do
  ...
  create_table "ai_settings", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["id"], name: "idx_ai_settings_singleton", unique: true
  end
  ...
  create_table "bounced_emails", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bounce_category"], name: "idx_bounced_emails_bounce_category"
    ...
    t.check_constraint "bounce_type IN ('hard', 'soft')", name: "bounced_emails_bounce_type_check"
  end
  ...
  create_table "tracking_events", force: :cascade do |t|
    ...
    t.check_constraint "event_type::text = ANY (ARRAY['open'::character varying, 'click'::character varying, 'bounce'::character varying, 'complaint'::character varying, 'delivered'::character varying, 'unsubscribe'::character varying]::text[])", name: "tracking_events_type_check"
  end
